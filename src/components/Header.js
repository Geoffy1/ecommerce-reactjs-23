  ...
  return <>
    <header className='header-top-strip py-3'>
      <div className='container-xxl'>
        <div className='row align-items-center'>
          <div className='col-6'>
            <p className='text-white mb-0'>Free delivery Over &100 & Free returns</p>
          </div>
          <div className='col-6'>
            <p className='text-end text-white'>
              Hotline: <a className='text-white' href="tel:+254716174485">+254716174485</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <header className='header-upper py-3'>
      <div className='container-xxl'>
        <div className='row'>
          <div className='col-2'>
            <h2><Link className='text-white'>SPIDYTEK.</Link></h2>
          </div>
          <div className='col-5'>
